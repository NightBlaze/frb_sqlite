...
fn wire_configure_database_impl(
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse(
                    (move || async move {
                        Result::<_, ()>::Ok(
                            crate::api::simple::configure_database(api_documents_dir).await,
                        )
                    })()
                    .await,
                )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        3 => wire_configure_database_impl(port, ptr, rust_vec_len, data_len),
